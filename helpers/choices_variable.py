from .constants import (
    ...
    PRODUCT_STATUS_TYPE,
    ORDER_STATUS,
    ORDER_LINE_STATUS, ASSET_TYPE, PRODUCT_CAT_TYPE, PRODUCT_TYPE, ACCOUNT_TYPE, PURCHASE_STATUS, PAYMENT_MODES, STOCK_TRANSACTION, POSITION)
...
PAYMENT_CHOICES = [
    ...
    (PAYMENT_MODES['ONLINE_PAYMENT'], 'ONLINE_PAYMENT')
]


STOCK_TRANSACTION_CHOICES = [
    (STOCK_TRANSACTION['PURCHASE'], 'PURCHASE'),
    (STOCK_TRANSACTION['DISPATCH'], 'DISPATCH'),
    (STOCK_TRANSACTION['RETURN'], 'RETURN')
]
