from .constants import (
    ...
    PRODUCT_STATUS_TYPE,
    ORDER_STATUS,
    ORDER_LINE_STATUS, ASSET_TYPE, PRODUCT_SUB_TYPE, PRODUCT_TYPE)
...
PRODUCT_TYPE_CHOICES = (
    ...
    (PRODUCT_TYPE['BAR'], 'BAR')
)

PRODUCT_SUB_TYPE_CHOICES = (
    (PRODUCT_SUB_TYPE['VEG'], 'VEG'),
    (PRODUCT_SUB_TYPE['NON-VEG'], 'NON-VEG'),
    (PRODUCT_SUB_TYPE['NONE'], None)
)