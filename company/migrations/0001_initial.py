    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('TOP', 'TOP'), ('BOTTOM', 'BOTTOM')], default='TOP', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='company_rating', to='company.Company')),
            ],
            options={
                'db_table': 'rating',
                'ordering': ['-created_at'],
